...
const Drawer = ({
  ...
  return (
    <div className={`fixed top-[71px] right-0 z-40 h-[calc(100vh-71px)] p-4 overflow-y-auto transition-transform bg-white w-full md:w-[40vw] shadow-2xl shadow-gray-800/50 border-r border-l-gray-800 ${isOpen ? "translate-x-0" : "translate-x-full"} border-2 `}
    tabIndex="-1"
